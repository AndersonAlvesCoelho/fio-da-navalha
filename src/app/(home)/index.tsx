...
import OptimizedDataList from '@/components/app/optimizedDataList';
...
export default function ScreenHome() {
  ...
  return (
    <View className="flex-1 items-center justify-center w-full rounded-md border border-red-500">
      <InputSearch
        // label="Search Fruits"
